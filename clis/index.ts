...
import { handleError, fakeLog } from '../utils';

const docUrl = 'https://goo.gl/Jhvi7m';
...
const argv = yargs
  ...
  .command(['docs'], `Go to the documentation at ${docUrl}`, {}, (_: any) => open(`${docUrl}`))
  .demandCommand(1, 'You need at least one command before moving on')
  .help('h')
  .alias('h', 'help')
  .epilogue(`for more information, find the documentation at ${docUrl}`)
  .fail(handleError)
  .argv;
